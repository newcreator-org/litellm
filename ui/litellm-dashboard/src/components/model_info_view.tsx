  ...
  const handleModelUpdate = async (values: any) => {
    try {
      ...
      try {
        ...
        NotificationsManager.fromBackend("Invalid JSON in Connect LM Params");
        setIsSaving(false);
        return;
      }
                ...
                >
                  <div className="space-y-4">
                    <div className="space-y-4">
                      ...
                      <div>
                        <Text className="font-medium">Connect LM Model Name</Text>
                        {isEditing ? (
                          <Form.Item name="litellm_model_name" className="mb-0">
                            <TextInput placeholder="Enter Connect LM model name" />
                          </Form.Item>
                        ) : (
                      ...
                      <div>
                        <Text className="font-medium">
                          Connect LM Params
                          <Tooltip title="Optional litellm params used for making a litellm.completion() call. Some params are automatically added by Connect LM.">
                            <a
