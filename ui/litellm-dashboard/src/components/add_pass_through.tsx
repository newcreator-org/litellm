      ...
      >
        <div className="mt-6">
          <Alert
            ...
            description="Route requests from your Connect LM proxy to any external API. Perfect for custom models, image generation APIs, or any service you want to proxy through Connect LM."
            type="info"
            showIcon
            className="mb-6"
          />
