    ...
    <div>
      ...
      <div style={{ marginBottom: 40 }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 4 }}>
          <h2 style={{ fontSize: 20, fontWeight: 600, color: "#111827", margin: 0 }}>Connect LM Content Filter</h2>
          <span
        ...
        <p style={{ fontSize: 13, color: "#6b7280", margin: "4px 0 20px 0" }}>
          Built-in guardrails powered by Connect LM. Zero latency, no external dependencies, no additional cost.
        </p>
        <div style={{
          display: "grid",
