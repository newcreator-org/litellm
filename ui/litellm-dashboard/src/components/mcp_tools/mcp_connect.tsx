    ...
    <Space direction="vertical" size="large" className="w-full">
      <div className="bg-gradient-to-r from-emerald-50 to-green-50 p-6 rounded-lg border border-emerald-100">
        <div className="flex items-center gap-3 mb-3">
          ...
          <Title level={4} className="mb-0 text-emerald-900">
            Connect LM Proxy API Integration
          </Title>
        </div>
        <Text className="text-emerald-700">
          Connect to Connect LM Proxy Responses API for seamless tool integration with multiple model providers
        </Text>
      </div>
      ...
      <Space direction="vertical" size="large" className="w-full">
        <FeatureCard
          ...
          description="Configure your Connect LM Proxy Virtual Key for authentication"
        >
          <Space direction="vertical" size="middle" className="w-full">
            <div>
              <Text>Get your Virtual Key from your Connect LM Proxy dashboard or contact your administrator</Text>
            </div>
        ...
        <FeatureCard
          ...
          description="Connection details for your Connect LM MCP server"
        >
        ...
        <FeatureCard
          ...
          description="Complete cURL example for using the Connect LM Proxy Responses API"
    ...
    <Space direction="vertical" size="large" className="w-full">
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-lg border border-blue-100">
        ...
        <Text className="text-blue-700">
          Connect OpenAI Responses API to your Connect LM MCP server for seamless tool integration
        </Text>
      </div>
    ...
    <Space direction="vertical" size="large" className="w-full">
      <div className="bg-gradient-to-r from-purple-50 to-blue-50 p-6 rounded-lg border border-purple-100">
        ...
        <Text className="text-purple-700">
          Use tools directly from Cursor IDE with Connect LM MCP. Enable your AI assistant to perform real-world tasks
    ...
    <Space direction="vertical" size="large" className="w-full">
      <div className="bg-gradient-to-r from-green-50 to-teal-50 p-6 rounded-lg border border-green-100">
        ...
        <Text className="text-green-700">
          Connect to Connect LM MCP using HTTP transport. Compatible with any MCP client that supports HTTP streaming.
        </Text>
      </div>
      ...
      <Space direction="vertical" size="large" className="w-full">
        <div>
          ...
          <TremorText className="text-lg text-gray-600">
            Use tools directly from any MCP client with Connect LM MCP. Enable your AI assistant to perform real-world
